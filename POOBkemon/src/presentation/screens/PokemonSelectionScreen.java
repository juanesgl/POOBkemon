...
public class PokemonSelectionScreen extends JPanel {
    ...
    private void initializeComponents() {
        ...
        startGameButton.addActionListener(e -> {
            ...
            if (isPlayer1Selection) {
                controller.startGame(selectedModality, selectedMode, selectedPokemons, null);
            } else {
                controller.startGame(selectedModality, selectedMode, player1Pokemons, selectedPokemons);
            }
        });
    ...
    private void createPokemonSelectionPanel() {
        ...
        pokemonSelectionPanel.setBounds(150, 100, 724, 400);
